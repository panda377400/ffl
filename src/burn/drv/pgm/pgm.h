...
#define PGMDBG(fmt, ...) bprintf(0, _T(fmt), ##__VA_ARGS__)
...
extern INT32 nPGMSPRMaskROMLen;
...
void install_protection_asic27a_kovlsqhp();
void install_protection_asic27a_py2k2();
void install_protection_asic27a_kovgsyxp();
void pgm_decrypt_kovzscs2s_program();
void pgm_decrypt_kovgsyxp_program();
void pgm_decode_kovgsyxp_samples();
...
void pgm_decrypt_kovlsqh2p_tiles(UINT8* tiles, INT32 size);
void pgm_decrypt_kovlsqh2p_sprites(unsigned char *src);
void pgm_decrypt_kovlsqh2p_samples();
void pgm_decrypt_kovlsqh2p();
void pgm_decrypt_kovlsqh2_program();
