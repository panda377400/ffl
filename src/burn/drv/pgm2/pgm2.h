...
struct Pgm2PerfDiagStats
{
	INT32 videoMode;
	INT32 screenW;
	INT32 screenH;
	INT32 spriteCount;
	INT32 zoomedSpriteCount;
	INT32 flippedSpriteCount;
	INT32 reverseSpriteCount;
	INT32 maxSpriteW;
	INT32 maxSpriteH;
	INT32 spritePixelsWritten;
	INT32 spritePixelsBlitted;
	INT32 bgPixelsDrawn;
	INT32 fgPixelsDrawn;
};

extern Pgm2PerfDiagStats Pgm2PerfDiag;
