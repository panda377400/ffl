...
extern struct MovieExtInfo Movielnfo;
...
#define HARDWARE_PREFIX_IGS                             (0x24000000)
#define HARDWARE_PREFIX_SKELETON                        (0x25000000)
#define HARDWARE_PREFIX_GBA                             (0x26000000)
#define HARDWARE_PREFIX_GB                              (0x27000000)
#define HARDWARE_PREFIX_GBC                             (0x28000000)
...
#define HARDWARE_IGS                                    (HARDWARE_PREFIX_IGS)
#define HARDWARE_SKELETON                               (HARDWARE_PREFIX_SKELETON)
#define HARDWARE_GBA                                    (HARDWARE_PREFIX_GBA)
#define HARDWARE_GB                                     (HARDWARE_PREFIX_GB)
#define HARDWARE_GBC                                    (HARDWARE_PREFIX_GBC)
