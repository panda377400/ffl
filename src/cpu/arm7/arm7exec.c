...
#if ARM9_MODE
#define THUMB_STACK_ADDR(sp) (sp)
#else
#define THUMB_STACK_ADDR(sp) (arm7_thumb_stack_align_fix ? ((sp) & ~3) : (sp))
#endif
                ...
                case 0xb: /* Stack-Related Opcodes */
                    switch ((insn & THUMB_STACKOP_TYPE) >> THUMB_STACKOP_TYPE_SHIFT)
                    {
                        ...
                        case 0x4: /* PUSH {Rlist} */
                            for (offs = 7; offs >= 0; offs--)
                            {
                                if (insn & (1 << offs))
                                {
                                    ...
                                    WRITE32(THUMB_STACK_ADDR(GET_REGISTER(13)), GET_REGISTER(offs));
                                }
                            }
                            R15 += 2;
                            break;
                        case 0x5: /* PUSH {Rlist}{LR} */
                            SET_REGISTER(13, GET_REGISTER(13) - 4);
                            WRITE32(THUMB_STACK_ADDR(GET_REGISTER(13)), GET_REGISTER(14));
                            for (offs = 7; offs >= 0; offs--)
                            {
                                if (insn & (1 << offs))
                                {
                        ...
                        case 0xc: /* POP {Rlist} */
                            for (offs = 0; offs < 8; offs++)
                            {
                                if (insn & (1 << offs))
                                {
                                    SET_REGISTER(offs, READ32(THUMB_STACK_ADDR(GET_REGISTER(13))));
                                    SET_REGISTER(13, GET_REGISTER(13) + 4);
                                }
                            }
                            R15 += 2;
                        ...
                        case 0xd: /* POP {Rlist}{PC} */
                            ...
                            {
                                UINT32 val = READ32(THUMB_STACK_ADDR(GET_REGISTER(13)));
                                SET_REGISTER(13, GET_REGISTER(13) + 4);
                                R15 = val & ~1;
#if ARM9_MODE
