...
#else
 #define DIRS_MAX (26)								// Maximum number of directories to search
#endif
...
extern TCHAR szAppArtworkPath[MAX_PATH];
...
#ifndef _IPS_MANAGER_H_
#define _IPS_MANAGER_H_

extern INT32 nRomOffset;
extern INT32 nActiveArray; 
extern INT32 nStandalone;
extern INT32 nDefineNum;
extern TCHAR** pszIpsActivePatches;
extern TCHAR CoreIpsPaths[DIRS_MAX][MAX_PATH];
extern TCHAR CoreRomDataPaths[DIRS_MAX][MAX_PATH];
