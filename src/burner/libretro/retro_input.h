...
#define RETROMAHJONG_KEYBOARD    RETRO_DEVICE_SUBCLASS(RETRO_DEVICE_ANALOG, 4)
#define RETROMOUSE_FULL          RETRO_DEVICE_SUBCLASS(RETRO_DEVICE_MOUSE, 1)
#define RETRO_DEVICE_TOUCHSCREEN RETRO_DEVICE_SUBCLASS(RETRO_DEVICE_POINTER, 0)

#define GIT_SPECIAL_SWITCH (0x03)
#define GIT_TOUCH          (0x04)
