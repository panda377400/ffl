...
//自定义扩展菜单文本
const char *pSelLangStrExt[NUM_STRING_EXT];

//自定义扩展菜单文本
const char *pSelLangStrExtGG[NUM_STRING_GONGGAO];
...
static const char* multi_language_strings[MAX_LANGUAGES][NUM_STRING] = {
	{
		...
		"1P memcard",
		"Player 1 PGM2 memory card settings.",
		"2P memcard",
		"Player 2 PGM2 memory card settings.",
		"3P memcard",
		"Player 3 PGM2 memory card settings.",
		"4P memcard",
		"Player 4 PGM2 memory card settings.",
		"Enable Memory Card",
		"Enable inserts the last selected card for this slot; disable ejects it",
		"Create New Memory Card",
		"Create a new card in %s and select it for this slot",
		"Card file: %s",
		"Create",
		"Memory card created successfully",
		"Failed to create memory card",
		"No available memory card to enable"
	},
	{	// Simplified Chinese
		"\u5c3d\u53ef\u80fd\u4f7f\u7528 32 \u4f4d\u8272\u6df1",
		...
		"\u6838\u5bf9\u4e0b\u5217\u96c6\u7ec4 : %s%s%s%s%s\n",
		"\u8bf7\u6ce8\u610f, \u5f53\u524d\u5e73\u53f0\u5df2\u7981\u7528 7z \u652f\u6301\u3002\n\n",
		"\u4ea4\u6d41\u7fa4: 797540537 / 556297887\n",
		"\u9a71\u52a8\u7a0b\u5e8f\u521d\u59cb\u5316\u5931\u8d25,\n\u60a8\u53ef\u4ee5\u5728\u5fc5\u8981\u7684\u65f6\u5019\u9009\u62e9\u53cd\u9988\u3002",
		"\u9a71\u52a8\u4e0d\u5b58\u5728\n\n\u8bf7\u5c1d\u8bd5\u4f7f\u7528 romdata \u6216 ips \u8865\u4e01\n\n",
		...
		"\u73a9\u5bb64 PGM2 \u8bb0\u5fc6\u5361\u8bbe\u7f6e\u3002",
		"\u542f\u7528\u8bb0\u5fc6\u5361",
		"\u542f\u7528\u65f6\u63d2\u5165\u8be5\u69fd\u4f4d\u6700\u540e\u9009\u62e9\u7684\u5361\uff0c\u7981\u7528\u65f6\u5f39\u51fa\u8bb0\u5fc6\u5361",
		"\u65b0\u5efa\u8bb0\u5fc6\u5361",
		"\u5728 %s \u4e2d\u65b0\u5efa\u4e00\u5f20\u8bb0\u5fc6\u5361\uff0c\u5e76\u5c06\u5176\u8bbe\u4e3a\u5f53\u524d\u69fd\u4f4d\u7684\u9009\u4e2d\u5361",
		"\u5361\u7247\u6587\u4ef6\uff1a%s",
		"\u65b0\u5efa",
		"\u65b0\u5efa\u8bb0\u5fc6\u5361\u6210\u529f",
		"\u65b0\u5efa\u8bb0\u5fc6\u5361\u5931\u8d25",
	...
	{	// Traditional Chinese
		...
		"\u73a9\u5bb64 PGM2 \u8a18\u61b6\u5361\u8a2d\u5b9a\u3002",
		"\u555f\u7528\u8a18\u61b6\u5361",
		"\u555f\u7528\u6642\u63d2\u5165\u6b64\u69fd\u4f4d\u6700\u5f8c\u9078\u64c7\u7684\u5361\uff0c\u505c\u7528\u6642\u5f48\u51fa\u8a18\u61b6\u5361",
		"\u65b0\u5efa\u8a18\u61b6\u5361",
		"\u5728 %s \u4e2d\u5efa\u7acb\u4e00\u5f35\u8a18\u61b6\u5361\uff0c\u4e26\u5c07\u5176\u8a2d\u70ba\u76ee\u524d\u69fd\u4f4d\u7684\u9078\u4e2d\u5361",
		"\u5361\u7247\u6a94\u6848\uff1a%s",
		"\u65b0\u5efa",
		"\u5efa\u7acb\u8a18\u61b6\u5361\u6210\u529f",
		"\u5efa\u7acb\u8a18\u61b6\u5361\u5931\u6557",
...
static const char* multi_language_strings_ext[MAX_LANGUAGES][NUM_STRING_EXT] = {
	{
		"Disable CRC checking",
		"Only match file names, suitable for running hacked version of games."
	},
	{	// Simplified Chinese
		"\u7981\u7528CRC\u68c0\u6d4b",
		"\u4ec5\u5339\u914d\u6587\u4ef6\u540d\uff0ccrc\u62a5\u9519\u65f6\u5c1d\u8bd5\u4f7f\u7528"
...
static const char* multi_language_strings_extgg[MAX_LANGUAGES][NUM_STRING_GONGGAO] = {
	{
		"Free to share, not for commercial use",
		"FinalBurn Neo Community Group: 797540537\nRetroArch Community Group: 556297887",
		"[Info]    Updated to the official version: 2026-03-06",
		"[Core]    Add Core for igs 017/027/m27 (Thanks to NanFangXiaoGui for helping modify the driver)",
		"[RomData] Compatible with Nebula format (Neo; Pgm; Cps1/2/3; Megadrive)",
		"[IPS]     Add quick launch support (hak; fid; lww)",
		"[Cheat]   Add support for compressed files (zip/7z)",
		"[Cheat]   Add rollback feature for main ROM cheats (by:zmhtt)",
		"[Core]    Add Disable CRC Checking",
		"[Input]   Add button macro configuration",
		"[Info]    Community Group: 797540537 / 556297887",
		"[Info]    Core Compilation: Qingtian"
	},
	{	// Simplified Chinese
		"\u6838\u5fc3\u4fee\u6539\u8bf4\u660e",
		"FinalBurn Neo \u4ea4\u6d41\u7fa4\uff1a797540537\nRetroArch\u5168\u80fd\u6a21\u62df\u5668\u4ea4\u6d41\u7fa4\uff1a556297887",
		"[Info]  \u66f4\u65b0\u81f3\u5b98\u65b9\u7248\u672c\uff1a2026-03-06",
		"[Core]  \u6dfb\u52a0igs 017/027/m27 \u652f\u6301(\u611f\u8c22 \u5357\u65b9\u5c0f\u9b3c \u5e2e\u5fd9\u4fee\u6539\u9a71\u52a8)",
		"[RomData]  \u517c\u5bb9 nebula \u683c\u5f0f (Neo; Pgm; Cps1/2/3; Megadrive)",
		"[IPS]  \u65b0\u589e\u5feb\u6377\u542f\u52a8\u652f\u6301(hak\uff1bfid\uff1blww)",
		"[Cheat]  \u65b0\u589e\u538b\u7f29\u5305\u652f\u6301(zip/7z)",
		"[Cheat]  \u65b0\u589e\u56de\u9000\u4e3bROM\u4f5c\u5f0a\u529f\u80fd(by:Mr\u9505\u5305\u8089)",
		"[Core]  \u65b0\u589e\u7981\u7528CRC\u68c0\u6d4b",
		"[Input]  \u6dfb\u52a0\u6309\u952e\u5b8f\u914d\u7f6e",
		"[Info]  \u4ea4\u6d41\u7fa4\uff1a797540537 / 556297887",
		"[Info]  \u6838\u5fc3\u7f16\u8bd1\uff1a\u6674\u5929"
	},
	{	// Traditional Chinese
		"\u6838\u5fc3\u4fee\u6539\u8aaa\u660e",
		"FinalBurn Neo \u4ea4\u6d41\u7fa4\uff1a797540537\nRetroArch\u5168\u80fd\u6a21\u64ec\u5668\u4ea4\u6d41\u7fa4\uff1a556297887",
		"[Info]  \u66f4\u65b0\u81f3\u5b98\u65b9\u7248\u672c\uff1a2026-03-06",
		"[Info]  \u6dfb\u52a0igs 017/027/m27 \u652f\u6301 (\u611f\u8b1d \u5357\u65b9\u5c0f\u9b3c \u5e6b\u5fd9\u4fee\u6539\u9a45\u52d5)",
		"[RomData]  \u517c\u5bb9 nebula \u683c\u5f0f (Neo; Pgm; Cps1/2/3; Megadrive)",
		"[IPS]  \u65b0\u589e\u5feb\u6377\u555f\u52d5\u652f\u6301(hak\uff1bfid\uff1blww)",
		"[Cheat]  \u65b0\u589e\u58d3\u7e2e\u5305\u652f\u6301(zip/7z)",
		"[Cheat]  \u65b0\u589e\u56de\u9000\u4e3bROM\u4f5c\u5f0a\u529f\u80fd(by:Mr\u934b\u5305\u8089)",
		"[Core]  \u65b0\u589e\u7981\u7528CRC\u6aa2\u6e2c",
		"[Input]  \u6dfb\u52a0\u6309\u9375\u5b8f\u914d\u7f6e",
		"[Info]  \u4ea4\u6d41\u7fa4\uff1a797540537 / 556297887",
		"[Info]  \u6838\u5fc3\u7de8\u8b6f\uff1a\u6674\u5929"
...
void set_multi_language_strings()
{
	...
	for (UINT32 i = 0; i < NUM_STRING_EXT; i++)
		pSelLangStrExt[i] = multi_language_strings_ext[nLangcode][i];

	for (UINT32 i = 0; i < NUM_STRING_GONGGAO; i++)
		pSelLangStrExtGG[i] = multi_language_strings_extgg[nLangcode][i];
}

#undef NUM_STRING
#undef NUM_STRING_EXT
#undef NUM_STRING_GONGGAO
#undef MAX_LANGUAGES
